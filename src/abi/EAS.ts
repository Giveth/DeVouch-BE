...
export const events = {
  Attested: new LogEvent<
    [recipient: string, attestor: string, uid: string, schema: string] & {
      recipient: string;
      attestor: string;
      uid: string;
      schema: string;
  ...
  RevokedOffchain: new LogEvent<
    [revoker: string, data: string, timestamp: bigint] & {
      revoker: string;
      data: string;
      timestamp: bigint;
    }
  >(abi, "0x92a1f7a41a7c585a8b09e25b195e225b1d43248daca46b0faf9e0792777a2229"),
  Timestamped: new LogEvent<
    [data: string, timestamp: bigint] & { data: string; timestamp: bigint }
...
export const functions = {
  ...
  attestByDelegation: new Func<
    ...
    string
  >(abi, "0xe13458fc"),
  getAttestTypeHash: new Func<[], {}, string>(abi, "0x12b11a17"),
  getAttestation: new Func<
    [uid: string],
    { uid: string },
    [
      uid: string,
  ...
  >(abi, "0xa3112a64"),
  getDomainSeparator: new Func<[], {}, string>(abi, "0xed24911d"),
  getNonce: new Func<[account: string], { account: string }, bigint>(
    abi,
    "0x2d0335ab"
  ),
  getRevokeOffchain: new Func<
    [revoker: string, data: string],
    { revoker: string; data: string },
    bigint
  >(abi, "0xb469318d"),
  getRevokeTypeHash: new Func<[], {}, string>(abi, "0xb83010d3"),
  getSchemaRegistry: new Func<[], {}, string>(abi, "0xf10b5cc8"),
  ...
  multiAttest: new Func<
    ...
    Array<string>
  >(abi, "0x44adc90e"),
  multiAttestByDelegation: new Func<
    [
      multiDelegatedRequests: Array<
        [
          schema: string,
          data: Array<
            [
    ...
    Array<string>
  >(abi, "0x831e05a1"),
  multiRevoke: new Func<
    [
      multiRequests: Array<
        [
          schema: string,
          data: Array<
            [uid: string, value: bigint] & { uid: string; value: bigint }
          >
        ] & {
          schema: string;
          data: Array<
    ...
    []
  >(abi, "0x4cb7e9e5"),
  multiRevokeByDelegation: new Func<
    [
      multiDelegatedRequests: Array<
        [
          schema: string,
    ...
    []
  >(abi, "0xe45d03f9"),
  multiRevokeOffchain: new Func<
    [data: Array<string>],
    { data: Array<string> },
    bigint
  >(abi, "0x13893f61"),
  multiTimestamp: new Func<
    [data: Array<string>],
    { data: Array<string> },
    bigint
  >(abi, "0xe71ff365"),
  revoke: new Func<
    [
      request: [
        schema: string,
        data: [uid: string, value: bigint] & { uid: string; value: bigint }
      ] & {
        schema: string;
        data: [uid: string, value: bigint] & { uid: string; value: bigint };
      }
