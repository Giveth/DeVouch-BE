module.exports = class Data1714407470955 {
    name = 'Data1714407470955'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "organisation" ("id" character varying NOT NULL, "name" text NOT NULL, "schema_user_field" text NOT NULL, "issuer" text NOT NULL, "color" text, CONSTRAINT "PK_c725ae234ef1b74cce43d2d00c1" PRIMARY KEY ("id"))`)
